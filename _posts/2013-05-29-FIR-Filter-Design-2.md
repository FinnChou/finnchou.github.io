...
math: true
image:
  path: /assets/resource/og/FIR-Filter-Design-2.png
  alt: "3.单位冲击响应，频响与FIR滤波器实现"
---
...
相位解卷绕的相关讨论，请参考 📎 <a href="{{ site.baseurl }}/posts/FIR-Filter-Phase-Unwrapping/"> >>[番外1]相位特性解卷绕 << </a> 。
